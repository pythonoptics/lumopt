...
script_1 = load_from_lsf(
    os.path.join(CONFIG["root"], "examples/Ysplitter/splitter_base_TE_modematch.lsf")
)
script_2 = load_from_lsf(
    os.path.join(
        CONFIG["root"], "examples/Ysplitter/splitter_base_TE_modematch_25nmoffset.lsf"
    )
)
...
geometry_1 = function_defined_Polygon(
    func=taper_splitter_1,
...
geometry_2 = function_defined_Polygon(
    func=taper_splitter_2,
    initial_params=initial_params,
    eps_out=1.44 ** 2,
    eps_in=2.8 ** 2,
    bounds=bounds,
...
opt_1 = Optimization(
    base_script=script_1, fom=fom_1, geometry=geometry_1, optimizer=optimizer_1
)
opt_2 = Optimization(
    base_script=script_2, fom=fom_2, geometry=geometry_2, optimizer=optimizer_2
)
